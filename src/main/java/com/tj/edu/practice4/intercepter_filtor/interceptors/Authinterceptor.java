package com.tj.edu.practice4.intercepter_filtor.interceptors;

import com.tj.edu.practice4.intercepter_filtor.annotations.AuthLog;
...
public class Authinterceptor implements HandlerInterceptor {
    ...
    private boolean checkAccessValidAnnotation(Object handler, Class clazz){
        ...
        if (authUserHandlerMethod != null
                || annotation != null){
            System.out.println("오노테이션 체크 class이름: " + clazz.getName());
            return true;
        }
